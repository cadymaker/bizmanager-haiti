...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Wè vant, kou pwodwi, depans, pèt, ak vrè benefis nèt ou, se pa yon chif apeprè.',
  },
  {
    icon: '🎟️',
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Boutik, sal fitness, pafimri, episri, famasi, magazen pyès, nenpòt biznis ki vann pwodwi oswa sèvis epi ki bezwen swiv kès, stock, ak kliyan.',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mt-5 leading-relaxed">
                Lojisyèl jesyon ki fèt pou biznis ayisyen. Vant, stock, kès, fakti,
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2 mt-6 text-sm text-gray-500">
                <span>Mache sou telefòn</span>
                <span>Tout an Kreyòl</span>
      ...
      <section id="tarif" className="bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mt-2">
              Yon pri ki fè sans pou biznis lokal nou yo
            </h2>
            <p className="text-gray-600 mt-3">
          ...
          <p className="text-center text-sm text-gray-500 mt-10">
            Pèman ak MonCash oswa cash · Tout fonksyonalite yo enkli nan chak plan
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-8 mt-10 shadow-sm">
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              ...
              te bezwen an nou menm, epi nou teste l chak jou nan pwòp biznis nou.
            </p>
            <p className="text-gray-700 leading-relaxed mt-4">
              Kounye a n ap pataje l ak lòt biznis ayisyen.{' '}
